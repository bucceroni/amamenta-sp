...
class ModalDetailsAdministrator extends React.Component {
  render() {
    const {
      fullScreen,
      openModal,
          ...
          <DialogActions>
            {dataModal.status === "PENDING" && (
              <Button
                color="primary"
                onClick={() =>
                  onApprove(dataModal.user_id, dataModal.institution_id)
                }
              >
                Liberar
              </Button>
            ...
            {dataModal.status === "APPROVED" && (
              <Button
                color="secondary"
                onClick={() =>
                  onRemove(dataModal.user_id, dataModal.institution_id)
                }
              >
                Deletar
              </Button>
...
ModalDetailsAdministrator.propTypes = {
...
export default withMobileDialog()(ModalDetailsAdministrator);
